  ...
  override fun definition() = ModuleDefinition {
    ...
    AsyncFunction("startMeeting") { meetingInfo: Map<String, Any>, attendeeInfo: Map<String, Any> ->
      try {
        ...
        // Validate required fields even if not directly used in configuration
        requireNotNull(meetingInfo["ExternalMeetingId"]?.toString()) { "ExternalMeetingId is required" }
        requireNotNull(meetingInfo["MediaRegion"]?.toString()) { "MediaRegion is required" }
